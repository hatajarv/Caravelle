...
# Funktio, joka lisää taustakuvan pseudo-elementtinä
def set_background():
    css = """
    <style>
    .stApp::before {
        content: "";
        background-image: url("https://lh3.googleusercontent.com/pw/AP1GczMebNg4BCFQefDWwx8k8fPHoQh3_oHA8TNKqVjGKjsOcKwsafnGn0AI_MtJ1k9andmNbzLmi2oZ9cFsNtFxM5fBI-47hmm4FsiTCbkJoN-WsBvmQFxt7jyRmXdSV-NzeBTr9wB8EJQw0VxaLC6HzN601g=w1836-h827-s-no-gm?authuser=0");
        background-size: 50%;
...
# Kovakoodattu data (sama kuin Excel-tiedoston sisältö)
data = [
...
# Lasketaan ajetut kilometrit ja keskiarvot
...
# Polttoainekustannukset: 9 l/100 km ja diesel hinta 1,70 €/l
diesel_price = 1.70
...
# Valmista x-akselin tick-arvot (päivämäärät 2 kuukauden välein)
